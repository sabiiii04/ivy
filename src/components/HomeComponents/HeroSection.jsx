...
const HeroSection = () => {
    return (
        <section className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${bg})`, }}>
            ...
            <div className="max-w-[1350px] max-auto relative z-10 flex items-center justify-start h-full px-6">
                <div className="max-w-4xl text-white text-start">
                    <h1 className="flex flex-col lg:leading-[80px]">
                        ...
                        <span className="text-[50px] lg:text-[120px] font-black text-nowrap uppercase mt-2">Grow Business</span>
                    </h1>
