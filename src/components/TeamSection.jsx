...
const TeamSection = () => {
    return (
        <section className="max-w-[1350px] mx-auto px-6 lg:px-20 py-16 text-center">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 mx-10 md:mx-0 gap-16 md:gap-6">
                {teamMembers.map((member, index) => (
                    <div key={index} className="relative bg-white rounded-lg shadow-lg mx-auto w-full lg:w-full">
                        ...
                        <div className="bg-white p-5 min-w-[185px] md:min-w-[230px] py-5 md:py-10 absolute -bottom-10 shadow-lg rounded-lg z-10">
